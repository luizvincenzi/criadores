-- ============================================================================
-- MIGRATION: SEED RELATÓRIO 360º
-- ============================================================================
-- Insere a LP de Relatório 360º e sua versão inicial
...
INSERT INTO landing_pages (
  ...
  '{
    "hero": {
      ...
      "trust_badges": ["100% Confidencial", "Entrega em 48h", "Sem compromisso"]
    },
    "problema": {
      "title": "Por que esse diagnóstico é diferente?",
      "problems": [
        {"icon": "🔍", "title": "Análise Completa", "description": "Analisamos seu posicionamento, conteúdo, anúncios e presença local."},
        {"icon": "🤖", "title": "Inteligência Artificial", "description": "Usamos IA e benchmarks do seu setor para insights precisos."},
        {"icon": "📊", "title": "Relatório Detalhado", "description": "Você recebe um PDF com insights práticos e plano de ação imediato."},
        {"icon": "👥", "title": "Consultoria 1-a-1", "description": "Conversa com um estrategista da crIAdores — sem custo, sem compromisso."}
      ]
    },
    "solucoes": [
      {
  ...
  '{
    ...
    "analytics": {"ga4_id": null, "meta_pixel_id": null},
    "features": {"show_urgency": false, "show_countdown": false, "show_mentor": false, "show_compliance": false},
...
WHERE lp.id = '20000000-0000-0000-0000-000000000007'
