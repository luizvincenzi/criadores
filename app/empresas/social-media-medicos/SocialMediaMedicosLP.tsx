...
export default function SocialMediaMedicosLP() {
  return (
    <div className="min-h-screen bg-surface">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white text-sm font-semibold mb-6">
              ...
              <span>100% Compliance CFM • Marketing Ético • Resultados Reais</span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Atraia Mais Pacientes Com{' '}
              <span className="text-secondary-container">Marketing Digital Ético e Profissional</span>
            </h1>

            <p className="text-xl text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
              Social media especializada para <strong>médicos, clínicas e consultórios</strong>.
              Conteúdo educativo, compliance total e agendamentos online.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <CTAButton chatbot="medicos" size="lg" />
            </div>
      ...
      {/* POR QUE MÉDICOS PRECISAM DE MARKETING DIGITAL */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-on-surface-variant leading-relaxed mb-8">
              O paciente moderno pesquisa online antes de agendar uma consulta.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="card-elevated p-6 text-center">
              ...
              <h3 className="font-bold text-on-surface mb-2">77% Pesquisam Online</h3>
              <p className="text-sm text-on-surface-variant">
                Antes de escolher um médico ou clínica
              </p>
            </div>
            ...
            <div className="card-elevated p-6 text-center">
              ...
              <h3 className="font-bold text-on-surface mb-2">Instagram é o #1</h3>
              <p className="text-sm text-on-surface-variant">
                Canal preferido para conhecer profissionais de saúde
              </p>
            </div>
            ...
            <div className="card-elevated p-6 text-center">
              ...
              <h3 className="font-bold text-on-surface mb-2">Conteúdo Educativo</h3>
              <p className="text-sm text-on-surface-variant">
                Gera confiança e autoridade profissional
              </p>
            </div>
          </div>
          ...
          <div className="card-elevated p-8 bg-gradient-to-br from-primary-container/30 to-secondary-container/30 text-center">
            ...
            <p className="text-lg text-on-surface-variant leading-relaxed">
              Por isso criamos uma solução completa de <strong>social media médica</strong> —
              ética, profissional e que gera agendamentos.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="card-elevated p-8">
              <div className="flex items-start mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-on-surface mb-2">Conteúdo Educativo</h3>
                  <p className="text-on-surface-variant">
                    2 Reels/semana + stories diários com dicas de saúde, prevenção e cuidados.
                    100% compliance CFM.
                  </p>
                </div>
              </div>
            ...
            <div className="card-elevated p-8">
              <div className="flex items-start mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-on-surface mb-2">Planejamento Mensal</h3>
                  <p className="text-on-surface-variant">
                    Calendário editorial completo com temas relevantes para sua especialidade.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card-elevated p-8">
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">
                    Respondemos comentários e DMs (sem orientação médica), direcionando para agendamento.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card-elevated p-8">
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">
                    Análise de alcance, engajamento e agendamentos gerados pelo Instagram.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card-elevated p-8">
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">
                    Todo conteúdo segue as normas do CFM. Você aprova tudo antes de publicar.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card-elevated p-8">
              <div className="flex items-start mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-on-surface mb-2">Link de Agendamento</h3>
                  <p className="text-on-surface-variant">
                    Integração com Doctoralia, Google Agenda ou seu sistema de agendamento.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center">
              <CTAButton chatbot="medicos" size="lg" className="mb-4" />
              <p className="text-sm text-on-surface-variant">
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-primary/95 to-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Fale com um especialista agora e descubra como podemos ajudar sua clínica/consultório.
          </p>
