              ...
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
                  <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-2.08v5.73a2.92 2.92 0 01-5.83 0V2H5.83v5.73a4.83 4.83 0 01-3.77 4.25v2.08a4.83 4.83 0 013.77 4.25V22h2.08v-3.65a2.92 2.92 0 015.83 0V22h2.08v-3.65a4.83 4.83 0 013.77-4.25V6.69z"/>
                  </svg>
                </div>
                <div>
