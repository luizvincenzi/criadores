...
export default function SouCriador() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Seção VIP Card - Nova - Background Preto */}
      <section className="py-20 bg-black relative overflow-hidden">
        {/* Background decorativo sutil */}
        <div className="absolute inset-0 overflow-hidden opacity-10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#0b3553] rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-gray-800 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
              Mais do que uma comunidade, um cartão de benefícios exclusivo com descontos
              e vantagens em diversos estabelecimentos parceiros da sua região.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-4xl mx-auto">
            {/* Benefício VIP 1 - Descontos */}
            <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-8 hover:border-[#0b3553] transition-all duration-300 hover:transform hover:scale-105">
              <div className="w-16 h-16 bg-[#0b3553] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-[#0b3553]/50">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-4 text-center">Descontos Exclusivos</h3>
              <p className="text-gray-400 text-center">Até 10% de desconto + entrada free em estabelecimentos parceiros</p>
            </div>

            {/* Benefício VIP 2 - Acesso VIP */}
            <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-8 hover:border-[#0b3553] transition-all duration-300 hover:transform hover:scale-105">
              <div className="w-16 h-16 bg-[#0b3553] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-[#0b3553]/50">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-bold text-white mb-4 text-center">Acesso VIP</h3>
              <p className="text-gray-400 text-center">Eventos exclusivos e networking premium</p>
            </div>
          </div>
          ...
          <div className="text-center">
            <a
              href="/criadoresvipcard"
              className="inline-flex items-center justify-center bg-[#0b3553] hover:bg-[#0a2f4a] text-white font-bold px-8 py-4 text-lg rounded-full transition-all duration-200 shadow-2xl shadow-[#0b3553]/50 hover:shadow-[#0b3553]/70 hover:transform hover:scale-105"
            >
              <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path>
              </svg>
              Conheça o Criadores VIP Card
            </a>
            <p className="mt-6 text-sm text-gray-400">
              Gratuito para todos os membros da comunidade crIAdores
            </p>
          </div>
        </div>
      </section>
