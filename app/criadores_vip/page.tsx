            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredCreators.map((creator) => (
                ...
                >
                  ...
                  {/* Informações */}
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#0b3553] transition-colors line-clamp-1">
                      {creator.name}
                    </h3>
                    ...
                    {creator.social_media?.instagram?.followers && (
                      <div className="flex items-center gap-2">
                        <div className="bg-[#0b3553]/10 text-[#0b3553] px-3 py-1.5 rounded-full text-xs font-bold">
